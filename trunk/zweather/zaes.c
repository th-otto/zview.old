...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &boussole->image[0], &screen);
...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &main_icon->image[0], &screen);
}
...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &forecast_icon[0]->image[0], &screen);
}
...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &forecast_icon[1]->image[0], &screen);
}
...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &forecast_icon[2]->image[0], &screen);
}
...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &forecast_icon[3]->image[0], &screen);
}
...
{	
	...
	vro_cpyfm( win->graf.handle, S_ONLY, xy, &forecast_icon[4]->image[0], &screen);
}
