...
struct png_struct_def
{
   ...
   long io_ptr;          /* ptr to application struct for I/O functions */
...
extern PNG_EXPORT(void,png_init_io) PNGARG((png_structp png_ptr, long fp));
#endif
...
extern PNG_EXPORT(void,png_set_write_fn) PNGARG((png_structp png_ptr,
   long io_ptr, png_rw_ptr write_data_fn, png_flush_ptr output_flush_fn));

/* Replace the default data input function with a user supplied one. */
extern PNG_EXPORT(void,png_set_read_fn) PNGARG((png_structp png_ptr,
   long io_ptr, png_rw_ptr read_data_fn));

/* Return the user pointer associated with the I/O functions */
extern PNG_EXPORT(long,png_get_io_ptr) PNGARG((png_structp png_ptr));
...
extern PNG_EXPORT(void,png_set_progressive_read_fn) PNGARG((png_structp png_ptr,
   long progressive_ptr,
   png_progressive_info_ptr info_fn, png_progressive_row_ptr row_fn,
   png_progressive_end_ptr end_fn));

/* returns the user pointer associated with the push read functions */
extern PNG_EXPORT(long,png_get_progressive_ptr)
   PNGARG((png_structp png_ptr));
