...
#define MAX_BYTES_IN_MARKER  65533L     /* maximum data len of a JPEG marker */
                       ...
                       unsigned int icc_data_len)
{
  ...
  size_t length;                /* number of bytes to write in this marker */
  ...
  num_markers = (unsigned int)(icc_data_len / MAX_DATA_BYTES_IN_MARKER);
  ...
  while (icc_data_len > 0) {
    ...
    icc_data_len -= (unsigned int)length;
