...
/* Allocate and fill in the sample_range_limit table */
{
	...
	jzero_far ( (void FAR *) table - (MAXJSAMPLE + 1), (MAXJSAMPLE+1) * SIZEOF(JSAMPLE));
	...
	for (i = CENTERJSAMPLE; i < (( MAXJSAMPLE + 1) << 1); i++)
		table[i] = MAXJSAMPLE;


	/* Second half of post-IDCT table */
	jzero_far ( (void FAR *) table + (( MAXJSAMPLE + 1) << 1), ( (( MAXJSAMPLE + 1) << 1) - CENTERJSAMPLE) * SIZEOF(JSAMPLE));
	jcopy ( ( unsigned char*)cinfo->sample_range_limit, ( unsigned char*)table + (((MAXJSAMPLE+1) << 2)- CENTERJSAMPLE), CENTERJSAMPLE * SIZEOF(JSAMPLE));
}
