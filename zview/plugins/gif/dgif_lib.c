...
#define READ(_gif,_buf,_len) (((GifFilePrivateType*)_gif->Private)->Read ? ((GifFilePrivateType*)_gif->Private)->Read(_gif,_buf,_len) : fread(_buf,1,_len,((GifFilePrivateType*)_gif->Private)->File))
...
DGifOpenFileHandle(int FileHandle) {
	...
	if( strcmp( GIF89_STAMP, ( char*)Buf) != 0) 
		GifFile->Version	= 1;
	else	
		GifFile->Version	= 0;
