static inline uint8 ditherize_32 ( uint8 * rgb, int16 * err, int8 ** buf)
{
	int8 	*dth = *buf;
...
static inline uint8 dither_true ( uint8 * rgb, int16 * err, int8 ** buf)
{
	int8 	*dth = *buf;
...
static inline uint8 dither_gray( uint8 *gray, int16 *err, int8 **buf)
{
	int8 	*dth  		= *buf;
