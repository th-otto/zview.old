...
TextLine *TextPage::buildLine(GList *charsA, int rot,
  ...
  int dir, dir2;
  GBool isrotated, spaceAfter, spaceBefore;
  int i, j;
  ...
  while (i < charsA->getLength()) {
    ...
    dir = getCharDirection(
	      ...
	      (i < charsA->getLength() - 1) ? (TextChar *)charsA->get(i+1)
	                                    : (TextChar *)NULL);
    isrotated = ((TextChar *)charsA->get(i))->rotated;
	...
	break;
	  ...
	  (control.splitRotatedWords && ch2->rotated != isrotated) ||
	  (dir && dir2 && dir2 != dir) ||
    ...
    word = new TextWord(charsA, i, j - i, rot, isrotated, dir,
